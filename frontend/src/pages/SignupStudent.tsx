      ...
      <div className="container-main pt-24 pb-16">
        <div className="grid gap-10 lg:grid-cols-2 items-center">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground mt-1">Authenticate directly with your official university Google account</p>
          </div>
          <div className="glass-card p-6 space-y-5">
            ...
            <div className="p-4 rounded-xl bg-secondary/40 border border-border/60 text-xs space-y-2 text-muted-foreground">
              <div className="font-semibold text-foreground flex items-center gap-1.5">
                <span>🔒 Zero Manual Password Sign-Up</span>
              </div>
              <ul className="space-y-1.5 list-disc pl-4 text-[11px] leading-relaxed">
                <li>Instant verification using your college Google Workspace (e.g. <code>@gla.ac.in</code> or <code>.ac.in</code>).</li>
                <li>Personal emails (<code>@gmail.com</code>) are strictly restricted for student roles.</li>
                <li>Custodial Polygon wallet and identity anchor automatically provisioned on first login.</li>
              </ul>
            </div>
