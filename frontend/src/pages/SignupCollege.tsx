      ...
      <div className="container-main pt-24 pb-16">
        <div className="grid gap-10 lg:grid-cols-2 items-center">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground mt-1">Authenticate directly with your official institution Google account</p>
          </div>
          <div className="glass-card p-6 space-y-5">
            ...
            <div className="p-4 rounded-xl bg-secondary/40 border border-border/60 text-xs space-y-2 text-muted-foreground">
              <div className="font-semibold text-foreground flex items-center gap-1.5">
                <span>🏛️ Faculty & Admin Access Policy</span>
              </div>
              <ul className="space-y-1.5 list-disc pl-4 text-[11px] leading-relaxed">
                <li>Automatic role validation against recognized college domains (e.g. <code>@gla.ac.in</code>).</li>
                <li>No manual password creation or credential storage required.</li>
                <li>Direct access to batch student verification, approval queues, and on-chain SBT minting.</li>
              </ul>
            </div>
